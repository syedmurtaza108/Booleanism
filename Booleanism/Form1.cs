...
namespace Booleanism
{
    public partial class Form1 : Form
    {
        ...
        public Panel Toolbox { get { return toolBoxOuter; } }
        ...
        private void nextBtn_EnabledChanged(object sender, EventArgs e)
        {
            ...
            allignHorizonBtn.Enabled = nextBtn.Enabled;
            allignJustifyBtn.Enabled = nextBtn.Enabled;
            allignTypeBtn.Enabled = nextBtn.Enabled;
        ...
        #region Gates Menu Strip methods

        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            andGatePicBox.Image = Properties.Resources.three_inp_and_gate;
            andGateLabel.Text = "2 Inputs";
        }

        private void toolStripMenuItem2_Click(object sender, EventArgs e)
        {
            andGatePicBox.Image = Properties.Resources.three_inp_and_gate;
            andGateLabel.Text = "3 Inputs";
        }

        private void toolStripMenuItem3_Click(object sender, EventArgs e)
        {
            andGatePicBox.Image = Properties.Resources.four_inp_and_gate;
            andGateLabel.Text = "4 Inputs";
        }

        private void toolStripMenuItem4_Click(object sender, EventArgs e)
        {
            andGatePicBox.Image = Properties.Resources.five_inp_and_gate;
            andGateLabel.Text = "5 Inputs";
        }


        private void toolStripMenuItem5_Click(object sender, EventArgs e)
        {
            orGatePicBox.Image = Properties.Resources.two_inp_or_gate;
            orGateLabel.Text = "2 Inputs";
        }

        private void toolStripMenuItem6_Click(object sender, EventArgs e)
        {
            orGatePicBox.Image = Properties.Resources.three_inp_or_gate;
            orGateLabel.Text = "3 Inputs";
        }

        private void toolStripMenuItem7_Click(object sender, EventArgs e)
        {
            orGatePicBox.Image = Properties.Resources.four_inp_or_gate;
            orGateLabel.Text = "4 Inputs";
        }

        private void toolStripMenuItem8_Click(object sender, EventArgs e)
        {
            orGatePicBox.Image = Properties.Resources.five_inp_or_gate;
            orGateLabel.Text = "5 Inputs";
        }

        private void toolStripMenuItem9_Click(object sender, EventArgs e)
        {
            xorGatePicBox.Image = Properties.Resources.two_inp_xor_gate;
            xorGateLabel.Text = "2 Inputs";
        }

        private void toolStripMenuItem10_Click(object sender, EventArgs e)
        {
            xorGatePicBox.Image = Properties.Resources.three_inp_xor_gate;
            xorGateLabel.Text = "3 Inputs";
        }

        private void toolStripMenuItem11_Click(object sender, EventArgs e)
        {
            xorGatePicBox.Image = Properties.Resources.four_inp_xor_gate;
            xorGateLabel.Text = "4 Inputs";
        }

        private void toolStripMenuItem12_Click(object sender, EventArgs e)
        {
            xorGatePicBox.Image = Properties.Resources.five_inp_xor_gate;
            xorGateLabel.Text = "5 Inputs";
        }

        private void toolStripMenuItem13_Click(object sender, EventArgs e)
        {
            nandGatePicBox.Image = Properties.Resources.two_inp_nand_gate;
            nandGateLabel.Text = "2 Inputs";
        }

        private void toolStripMenuItem14_Click(object sender, EventArgs e)
        {
            nandGatePicBox.Image = Properties.Resources.three_inp_nand_gate;
            nandGateLabel.Text = "3 Inputs";
        }

        private void toolStripMenuItem15_Click(object sender, EventArgs e)
        {
            nandGatePicBox.Image = Properties.Resources.four_inp_nand_gate;
            nandGateLabel.Text = "4 Inputs";
        }

        private void toolStripMenuItem16_Click(object sender, EventArgs e)
        {
            nandGatePicBox.Image = Properties.Resources.five_inp_nand_gate1;
            nandGateLabel.Text = "5 Inputs";
        }

        private void toolStripMenuItem17_Click(object sender, EventArgs e)
        {
            norGatePicBox.Image = Properties.Resources.two_inp_nor_gate;
            norGateLabel.Text = "2 Inputs";
        }

        private void toolStripMenuItem18_Click(object sender, EventArgs e)
        {
            norGatePicBox.Image = Properties.Resources.three_inp_nor_gate;
            norGateLabel.Text = "3 Inputs";
        }

        private void toolStripMenuItem19_Click(object sender, EventArgs e)
        {
            norGatePicBox.Image = Properties.Resources.four_inp_nor_gate;
            norGateLabel.Text = "4 Inputs";
        }

        private void toolStripMenuItem20_Click(object sender, EventArgs e)
        {
            norGatePicBox.Image = Properties.Resources.five_inp_nor_gate;
            norGateLabel.Text = "5 Inputs";
        }
        ...
        private void BrownTheme()
        {
            ...
            toolBoxOuter.BackColor = Color.PeachPuff;
            gatesLabelPanel.BackColor = Color.BlanchedAlmond;
        ...
        private void BlueTheme()
        {
            ...
            toolBoxOuter.BackColor = configPanelOuter.BackColor;
            gatesLabelPanel.BackColor = Color.PowderBlue;
            panel2.BackColor = gatesLabelPanel.BackColor;
            panel3.BackColor = gatesLabelPanel.BackColor;
            panel4.BackColor = gatesLabelPanel.BackColor;
            toolBox.BackColor = Color.White;
        ...
        private void GreenTheme()
        {
            ...
            toolBoxOuter.BackColor = configPanelOuter.BackColor;
            gatesLabelPanel.BackColor = Color.Honeydew;
            panel2.BackColor = gatesLabelPanel.BackColor;
            panel3.BackColor = gatesLabelPanel.BackColor;
            panel4.BackColor = gatesLabelPanel.BackColor;
            toolBox.BackColor = Color.Honeydew;
        ...
        private void SetViewToolstrip()
        {
            if (Properties.Settings.Default.isToolbox)
                hideToolboxToolStripMenuItem.Image = Properties.Resources.ok_16x16;
            if (Properties.Settings.Default.isProperties)
                hidePropertiesToolStripMenuItem.Image = Properties.Resources.ok_16x16;
        ...
        private void ToolbarSetting()
        {
            int a = 24;
            if (Properties.Settings.Default.isToolbox)
                toolBoxOuter.Visible = true;
            else
                toolBoxOuter.Visible = false;
            if (Properties.Settings.Default.isProperties)
            ...
            if (Properties.Settings.Default.isTruthTool)
                ...
                tableTool.Hide();
            topPanel.Size = new Size(topPanel.Width, a);
            ...
            toolBoxForm.ToolboxOuter.BackColor = toolBoxOuter.BackColor;
            toolBoxForm.Toolbox.BackColor = toolBox.BackColor;
            toolBoxForm.HeadingPanel.BackColor = gatesLabelPanel.BackColor;
        }
        ...
        private void hideToolboxToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.isToolbox)
            {
                ...
                hideToolboxToolStripMenuItem.Image = null;
                toolBoxOuter.Visible = false;
            }
            else
            {
        ...
        private void hidePropertiesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.isProperties)
            {
                ...
                hidePropertiesToolStripMenuItem.Image = null;
                configPanelOuter.Visible = false;
            }
            else
            {
        ...
        {
            ToolStrip s = (ToolStrip)sender;
            if (s.Visible)
                topPanel.Size = new Size(topPanel.Width, topPanel.Height + s.Height);
            else
                topPanel.Size = new Size(topPanel.Width, topPanel.Height - s.Height);
        }
